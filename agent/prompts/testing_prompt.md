...
2. Produce a detailed regression-testing plan (covering billing & subscriptions,
   ...
   `./refactored/reasoning_artifacts/testing_plan.md`.
...
All plans must live in `./refactored/reasoning_artifacts/`, and all tests/helpers belong under
`./refactored/tests/`. Output only the plan and the test file contents—no additional commentary.
