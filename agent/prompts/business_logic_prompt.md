...
2. Produce **exactly one** Markdown file at
   `./refactored/documentation/business_logic/<module_name>.md` summarizing:
...
Do not create packages or `__init__.py` files—only the Markdown documents.
